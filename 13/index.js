...
console.log(
  (sorted.findIndex(a => Array.isArray(a) && a.length === 1 && Array.isArray(a[0]) && a[0].length === 1 && a[0][0] === 2) + 1)
  *
  (sorted.findIndex(a => Array.isArray(a) && a.length === 1 && Array.isArray(a[0]) && a[0].length === 1 && a[0][0] === 6) + 1)
)

function compare(a, b) {
  if (Array.isArray(a) && ! Array.isArray(b)) b = [b]
